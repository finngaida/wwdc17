...
class NeutralFaceAnimator: FaceAnimator {
    ...
    func nod() {
        ...
        self.nodding = true
        let nod = CGAffineTransform.identity.rotated(by: flipACoin() ? 0.1 : -0.1)
...
class LaughingFaceAnimator: FaceAnimator {
    ...
    func executeAnimation() {
        ...
        after(0.8) {
            UIView.animate(withDuration: 1, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
                faceView.transform = CGAffineTransform.identity.translatedBy(x: 0, y: -40)
            }) { _ in
                UIView.animate(withDuration: 0.5, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
                    faceView.transform = CGAffineTransform.identity.translatedBy(x: 0, y: 3)
                }) { _ in
    ...
    func giggleUntilToldToStop() {
        ...
        UIView.animate(withDuration: 0.1, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
            faceView.transform = CGAffineTransform.identity.scaledBy(x: 1, y: 0.95).rotated(by: 0.1 * self.lastTiltAdjustment)
        }) { _ in
            UIView.animate(withDuration: 0.1, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
                faceView.transform = CGAffineTransform.identity.rotated(by: 0.1 * -self.lastTiltAdjustment)
            }) { _ in
...
class ConfusedFaceAnimator: FaceAnimator {
    ...
    func executeAnimation() {
        ...
        UIView.animate(withDuration: 1, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
            faceView.transform = CGAffineTransform.identity.scaledBy(x: 0.90, y: 1)
        }) { _ in
...
class AnnoyedFaceAnimator: FaceAnimator {
    ...
    func executeAnimation() {
        ...
        UIView.animate(withDuration: 1, delay: 0, options: [.beginFromCurrentState, .allowUserInteraction], animations: {
            faceView.transform = CGAffineTransform.identity.scaledBy(x: 1, y: 0.9)
        }) { _ in
            after(0.5) {
                guard self.running, let faceView = self.faceView else { self.cleanup(); return }
    ...
    func planToNod() {
        ...
        after(timeUntilNod) {
            ...
            let nod = CGAffineTransform.identity.translatedBy(x: (flipACoin() ? 6 : -6), y: 0)
